...
int main(){
    ...
    int n = s.length();
    cout<<"Using recursion: "<<n-lcsRec(n-1, n-1, s, t)<<"\n";

    vector<vector<int>> dp(n, vector<int>(n,-1));
    cout<<"Using memoization: "<<n-lcsMem(n-1, n-1, s, t, dp)<<"\n";

    cout<<"Using tabulation: "<<n-lcsTab(s, t)<<"\n";

    cout<<"Using space optimisation: "<<n-lcsSp(s, t)<<"\n";
    return 0;
}