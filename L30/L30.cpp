// minimum operations to convert a str1 to str2 
...
int main(){
    ...
    int n = s.length(), m = t.length();
    cout<<"Using recursion: "<<n+m-2*lcsRec(n-1, n-1, s, t)<<"\n";

    vector<vector<int>> dp(n, vector<int>(n,-1));
    cout<<"Using memoization: "<<n+m-2*lcsMem(n-1, n-1, s, t, dp)<<"\n";

    cout<<"Using tabulation: "<<n+m-2*lcsTab(s, t)<<"\n";

    cout<<"Using space optimisation: "<<n+m-2*lcsSp(s, t)<<"\n";
    return 0;
}